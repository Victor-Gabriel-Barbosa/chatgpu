  ...
  return (
    ...
    >
      ...
      >
        <button 
          onClick={onClose}
          className="absolute top-4 right-4 cursor-pointer text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white transition-colors"
        >
          <X size={20} />
        </button>
        ...
        <div className="space-y-4">
          <div>
            ...
            <select
              ...
              className="w-full bg-slate-100 text-slate-900 dark:bg-slate-800 dark:text-white rounded-xl px-3 py-2 transition-colors cursor-pointer appearance-none"
            >
        ...
        <div className="mt-8 flex justify-end">
          <button
            onClick={handleSave}
            className="px-4 py-2 text-white dark:text-black bg-slate-900 dark:bg-slate-200 hover:bg-slate-800 dark:hover:bg-slate-200 font-medium rounded-md cursor-pointer transition-colors"
          >
            Salvar & Fechar
          </button>
        </div>
